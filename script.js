...
//this function swiches the player
...
const init = function () {
  ...
  palyer1Element.classList.remove("player--winner");
  player0Element.classList.remove("player--looser");
  palyer1Element.classList.remove("player--looser");
  player0Element.classList.add("player--active");
  palyer1Element.classList.remove("player--active");
};
...
btnHold.addEventListener("click", function () {
  if (playing) {
    // add acore to active player score
